...
export function ResourceCard({ resource, categoryColor }: ResourceCardProps) {
  ...
  return (
    <Card className="bg-[#051728E5] border border-[#83E9FF4D] hover:border-[#83E9FF80] transition-all shadow-sm hover:shadow-lg group overflow-hidden">
      <CardContent className="p-0">
        ...
        >
          ...
          <div className="relative h-48 w-full overflow-hidden bg-[#112941]">
            ...
            >
              {isBookmarked ? (
                <BookmarkCheck size={16} className="text-[#83E9FF]" />
              ) : (

    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
                <label htmlFor="resourceUrl" className="text-xs text-text-secondary font-semibold uppercase tracking-wider">Resource URL *</label>
                <Input
                    id="resourceUrl"
                    type="url"
                    value={form.url}
            ...
            <div className="space-y-2">
                <label htmlFor="resourceCategory" className="text-xs text-text-secondary font-semibold uppercase tracking-wider">Category *</label>
                <Select

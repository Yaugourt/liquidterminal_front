...
// Lightweight Charts options (`lwcDefaults`, `createLwcChartOptions`) live in
// `./lwcTheme` — kept out of this file so importing the palette doesn't pull
// `lightweight-charts` into every bundle that needs a color.

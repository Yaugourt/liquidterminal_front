        ...
        >
          {suggestions.map((suggestion, index) => (
            <button
              ...
              type="button"
              className={`w-full px-4 py-3 text-left hover:bg-[#1E3851] transition-colors border-none ${
                index === selectedSuggestion ? 'bg-[#1E3851]' : ''
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ChevronDown className="h-3 w-3 text-[#83E9FF33] rotate-[-90deg]" />
              </div>
            </button>
          ))}
        </div>

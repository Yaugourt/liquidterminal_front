    ...
    <Card className="p-3 bg-[#051728E5] border border-[#83E9FF4D] shadow-sm backdrop-blur-sm hover:border-[#83E9FF66] transition-all rounded-md h-full flex flex-col">
      ...
      <div className="space-y-3 flex-1">
        <div className="flex items-start gap-2">
          <Shield className="h-4 w-4 text-[#f9e370] mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-white text-xs font-medium">Permissionless Perps</p>
        ...
        <div className="flex items-start gap-2">
          <Coins className="h-4 w-4 text-[#f9e370] mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-white text-xs font-medium">500k HYPE Stake</p>
            <p className="text-[#FFFFFF80] text-[10px]">
        ...
        <div className="flex items-start gap-2">
          <Scale className="h-4 w-4 text-[#f9e370] mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-white text-xs font-medium">50% Fee Share</p>
            <p className="text-[#FFFFFF80] text-[10px]">

    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
      ...
      <div className="relative flex-1">
        ...
        <Input
          ...
          className="pl-9 bg-[#0A0D12] border-white/5 text-white placeholder:text-zinc-600 focus:border-[#83E9FF]/50 text-sm h-9"
        />
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={selectedRole} onValueChange={onRoleChange}>
          <SelectTrigger className="w-full sm:w-36 bg-[#0A0D12] border-white/5 text-white text-sm h-9">

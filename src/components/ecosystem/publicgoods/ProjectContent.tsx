        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-brand-secondary/60 backdrop-blur-md border border-border-subtle rounded-2xl shadow-xl shadow-black/20 p-6">
                ...
                <div className="space-y-4">
                    <div>
                        <h3 className="text-label text-brand-accent mb-2">Problem Solved</h3>
                        <p className="text-text-secondary text-sm">{project.problemSolved}</p>
                    </div>

                    <div>
                        <h3 className="text-label text-brand-accent mb-2">Target Users</h3>
                    ...
                    <div>
                        <h3 className="text-label text-brand-accent mb-2">HyperLiquid Integration</h3>
                        <p className="text-text-secondary text-sm">{project.hlIntegration}</p>
                    </div>

                    <div>
                        <h3 className="text-label text-brand-accent mb-2">Development Status</h3>
            ...
            <div className="bg-brand-secondary/60 backdrop-blur-md border border-border-subtle rounded-2xl shadow-xl shadow-black/20 p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <h3 className="text-label text-brand-accent mb-2">Experience Level</h3>
                        ...
                        <div>
                            <h3 className="text-label text-brand-accent mb-2">Category</h3>
                            <Badge className="bg-brand-accent/10 text-brand-accent text-xs">
                                {project.category}
                            </Badge>
                        </div>
                    ...
                    <div>
                        <h3 className="text-label text-brand-accent mb-2">Technologies Used</h3>
                        <div className="flex flex-wrap gap-2">
                ...
                <div className="bg-brand-secondary/60 backdrop-blur-md border border-border-subtle rounded-2xl shadow-xl shadow-black/20 p-6">
                    ...
                    <div className="space-y-4">
                        {project.supportTypes.length > 0 && (
                            <div>
                                <h3 className="text-label text-brand-accent mb-2">Types of Support</h3>
                                <div className="flex flex-wrap gap-2">
                        ...
                        {project.supportTypes.includes('CONTRIBUTOR') && project.contributorTypes.length > 0 && (
                            <div>
                                <h3 className="text-label text-brand-accent mb-2">Looking for Contributors</h3>
                                <div className="flex flex-wrap gap-2">

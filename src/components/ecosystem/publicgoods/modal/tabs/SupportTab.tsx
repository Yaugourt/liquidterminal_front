      ...
      <div>
        ...
        <div className="space-y-2 mt-2">
          {SUPPORT_TYPES.map(type => (
            <div key={type.value} className="flex items-start space-x-3 p-3 bg-brand-dark border border-border-subtle rounded-lg hover:border-border-hover transition-colors">
              <Checkbox
                id={type.value}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            {CONTRIBUTOR_TYPES.map(type => (
              <div key={type.value} className="flex items-center space-x-2 p-2 bg-brand-dark border border-border-subtle rounded-lg hover:border-border-hover transition-colors">
                <Checkbox

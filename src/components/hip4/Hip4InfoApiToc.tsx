...
export function Hip4InfoApiToc({ variant }: { variant: "inline" | "sidebar" }) {
  if (variant === "inline") {
    return (
      <div className="rounded-lg border border-border-subtle bg-surface/30 p-3 xl:hidden">
        <div className="mb-2 text-[10px] font-bold uppercase tracking-wider text-gold/90">
          On this page
        </div>
  ...
  return (
    ...
    >
      <div className="mb-3 text-[10px] font-bold uppercase tracking-wider text-gold/90">
        On this page
      </div>

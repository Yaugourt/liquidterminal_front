...
const STORAGE_SLOTS: StorageSlot[] = [
  {
    ...
    decoded: <StatusBadge variant="gold">Owner</StatusBadge>,
  },
  {
    slot: "1",
    raw: "0x0",
  ...
  },
  {
    slot: "2",
    raw: "…0001",
    decoded: <StatusBadge variant="neutral">Initialized = 1</StatusBadge>,
  },
];

const SLOT_COLUMNS: Column<StorageSlot>[] = [
  { key: "slot", header: "Slot", type: "code", accessor: "slot" },
  { key: "raw", header: "Raw", type: "code", className: "break-all", accessor: "raw" },
  { key: "decoded", header: "Decoded", accessor: (r) => r.decoded },
];
  ...
  return (
    <Hip4ChapterShell>
      ...
      <section className="space-y-3">
        <Hip4SectionTitle className="!mb-0">V1 — proxy / implementation slots (summary)</Hip4SectionTitle>

...
import { AuctionCard } from "@/components/market/perp/auction/AuctionCard";
import { AuctionTable } from "@/components/market/perp/auction/AuctionTable";
import { AuctionChartSection } from "@/components/market/perp/auction/AuctionChartSection";
...
export default function PerpAuctionPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Main content */}
      <div>
        <Header customTitle="Perpetual Auctions" showFees={true} />

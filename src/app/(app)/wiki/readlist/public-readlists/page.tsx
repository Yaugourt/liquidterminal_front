        ...
        <div className="bg-brand-secondary/60 backdrop-blur-md border border-white/5 rounded-2xl p-8 max-w-md w-full mx-4 shadow-xl shadow-black/20">
          <div className="text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-accent hover:bg-brand-accent/90 text-brand-tertiary font-semibold rounded-lg transition-colors text-sm"
            >
              Try Again
            </button>
          </div>
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                ...
                {pagination && (
                  <span className="ml-1.5 text-text-muted">· {pagination.total} lists</span>
                )}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                ...
                className="pl-9 h-9 bg-brand-secondary/60 border-border-subtle text-white text-sm rounded-lg placeholder:text-text-muted focus:border-brand-accent/50"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex bg-brand-secondary/60 border border-border-subtle rounded-lg p-1 gap-0.5">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1.5 bg-brand-secondary/60 border border-border-subtle hover:border-border-hover text-text-muted hover:text-white rounded-lg text-xs transition-all"
            ...
            {loading ? (
              ...
              >
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="bg-brand-secondary/60 border border-border-subtle rounded-2xl p-4 animate-pulse space-y-3">
              ...
              <motion.div
                ...
                className="bg-brand-secondary/60 backdrop-blur-md border border-white/5 rounded-2xl p-12"
              >
                <div className="text-center">

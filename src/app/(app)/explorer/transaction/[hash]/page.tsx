    ...
    return (
      <div className="flex justify-center items-center min-h-[400px]">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <span className="text-white/50 text-sm font-inter">{error.message}</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex justify-center items-center min-h-[400px]">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <span className="text-white/50 text-sm font-inter">The transaction hash may be invalid or not yet indexed</span>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-3 bg-surface/90 border border-brand/30 rounded-lg p-4">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <button
            ...
            className="p-1 hover:bg-white/4 rounded transition-colors flex-shrink-0"
          >
            {copiedHash ? (
